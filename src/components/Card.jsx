  ...
  return (
    <div className="flex flex-col md:relative">
      <div className="md:absolute top-[-7rem] z-[10] mx-auto">
        <img
          className="aspect-square rounded-full w-[140px] h-[140px] z-[25] absolute md:relative"
          src={review.image}
        />
        <div
          className="w-[140px] h-[140px] bg-violet-500 rounded-full md:absolute relative
